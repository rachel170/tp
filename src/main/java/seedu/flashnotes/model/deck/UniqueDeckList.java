 ...
 * A deck is considered unique by comparing using {@code Deck#isSameDeck(Deck)}.
 * As such, adding and updating of deck uses Deck#isSameDeck(Deck) for equality
 * so as to ensure that the deck being added or updated is unique in terms of identity in the UniqueDeckList.
 * However, the removal of a deck uses Deck#equals(Object) so
